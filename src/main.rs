...
fn spawn_paddles(
    ...
    if let Ok(window) = window.get_single() {
        ...
        let left_paddle_x = -right_paddle_x;
...
fn spawn_gutters(
    ...
    if let Ok(window) = window.get_single() {
        ...
        let top_gutter_y = window_height / 2. - GUTTER_HEIGHT;
        let bottom_gutter_y = -top_gutter_y;
        ...
        let material = materials.add(Color::srgb(0., 0., 0.));
